...
export const DEFAULT_SYSTEM_PROMPT = [
  ...
  "",
  "AUTONOMOUS TERMINAL & GITHUB PROTOCOL:",
  "- When the user asks you to execute a terminal command, run tests, fix build errors, or push to GitHub, NEVER ask the user to manually run the command themselves in their terminal.",
  "- Instead, execute <BDS:AUTO:TERMINAL command=\"...\"></BDS:AUTO:TERMINAL> or <BDS:AUTO:GIT_PUSH message=\"...\"></BDS:AUTO:GIT_PUSH> directly.",
  "- The autonomous agent will execute the task, monitor for any errors, auto-fix any issues, and return the live execution result back into the conversation.",
